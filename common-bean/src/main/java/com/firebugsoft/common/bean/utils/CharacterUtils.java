package com.firebugsoft.common.bean.utils;
...
public final class CharacterUtils {
	/** ascii码: _ */
	public static final byte UL = (byte) 0x5F;
    ...
    public static String toCamelUpperCase(String underlineCase) {
        ...
        int index = 0;
        for (int i = 0; i < bs.length; i++) {
            bs[index++] = bs[i] == UL ? CharacterUtils.toUpperCase(bs[++i]) : bs[i];
        }
        CharacterUtils.toUpperCaseFirst(bs);
